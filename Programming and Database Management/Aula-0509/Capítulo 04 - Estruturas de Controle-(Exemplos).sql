...
-- em expressao case eu atribuo um valor para uma variavel apos uma condição case
...
--agora aqui é uma instrução CASE, parecido com switch case do Java
DECLARE
   deptid NUMBER;
...
-- WHILE LOOP - USADO QUANDO EU NÃO SEI A QUANTIDADE DE LOOPS E QUANDO FOR VERDADE
